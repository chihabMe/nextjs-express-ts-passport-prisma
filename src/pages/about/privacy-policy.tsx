...
const PrivacyPolilcyPage = () => {
  return (
    <>
      <Head>
        <title>housy privacy policy</title>
      </Head>
      <main className="flex px-2 md:px-0">
        <section className="w-full max-w-3xl mx-auto pt-10 text-sm text-text">
          <h1 className="text-lg font-medium">Privacy Policy for housy</h1>

          <p>
            At housy.com, accessible from back-4s3g.onrender.com, one of our
            main priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by housy.com and how we use it. If you have additional
            ...
            housy.com. This policy is not applicable to any information
          ...
          <p>
            housy.com follows a standard procedure of using log files. These
            ...
            website, housy.com uses "cookies". These cookies are used to store
            ...
            housy.com. Third-party ad servers or ad networks uses technologies
            like cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on housy.com, which
            ...
            you visit. Note that housy.com has no access to or control over
            these cookies that are used by third-party advertisers. Third Party
            Privacy Policies housy.com's Privacy Policy does not apply to other
          ...
          <p>
            ...
            housy.com does not knowingly collect any Personal Identifiable
            ...
            was created with the help of the Privacy Policy Generator. Contact
...
export default PrivacyPolilcyPage;
